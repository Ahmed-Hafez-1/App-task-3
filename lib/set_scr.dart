...
class set_scr extends StatefulWidget {
  const set_scr({Key? key}) : super(key: key);

  @override
  State<set_scr> createState() => _set_scr();
}

class _set_scr extends State<set_scr> {
  String userPhone = "";
  @override
  void initState() {
    super.initState();
  ...
  Future<void> getUserPhoneNumber() async {
    userPhone = await set_u.getCachedUserPhone();
    setState(() {});
  }
